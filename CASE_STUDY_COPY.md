...
Recommended mobile captures (390×844 @2x) live in [`docs/screenshots/mobile/`](./docs/screenshots/mobile/). Regenerate with `npm run screenshots:mobile` (see [`docs/screenshots/README.md`](./docs/screenshots/README.md)).
