...
Recommended mobile (390×844), tablet (768×1024), and desktop (1440×900) screenshots are in [`docs/screenshots/`](./docs/screenshots/). Regenerate with `npm run screenshots:mobile`, `npm run screenshots:tablet`, `npm run screenshots:desktop`, or `npm run screenshots` while preview is running.
